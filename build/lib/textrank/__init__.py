...
def extract_key_phrases(text):
    ...
    :param text: A string.
    """
    print("::::::::::Process of Extracting PHRASES Starts:::::::::::")
    print("Original Data:\n")
    print(text)
    ...
    print("After applying the filter for POS tags:\n")
    print(tagged)
    ...
    while j < len(textlist):
        ...
        i = i + 1
        j = j + 1
    print("::::::::::Process of extraction PHRASES Ends:::::::::::")
...
def extract_sentences(text, summary_length=120, clean_sentences=False, language='english'):
    ...
    :param text: A string.
    """
    print("::::::::::Process of extraction SUMMARY Starts:::::::::::")
    ...
    print("graph Associated:\n")
    print(graph)
    calculated_page_rank = nx.pagerank(graph, weight='weight')
    print("pagerank Applied:\n")
    print(calculated_page_rank)
    ...
    print("::::::::::Process of extraction SUMMARY Ends:::::::::::")
    return summary